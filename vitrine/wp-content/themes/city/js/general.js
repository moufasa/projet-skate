...
(function($){
	...
	$.fn.bxSlider = function(options){		
		...
		var defaults = {
			...
			nextImage: 'http://iamthemes.com/themeforest/wordpress/city/wp-content/themes/city/image/theme/rightar.png',											// string - filepath of image used for 'next' control. ex: 'images/next.jpg'
			nextSelector: null,									// jQuery selector - element to contain the next control. ex: '#next'
			prevText: '',										// string - text displayed for 'previous' control
			prevImage: 'http://iamthemes.com/themeforest/wordpress/city/wp-content/themes/city/image/theme/leftar.png',											// string - filepath of image used for 'previous' control. ex: 'images/prev.jpg'
