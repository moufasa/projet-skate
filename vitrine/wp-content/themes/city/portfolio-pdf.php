<?php /** Template Name: Portfolio PDF */ get_header(); ?>
...
<!-- #Page Back -->
    ...
    <div id="listportfolio" class="grid_16">
        ...
        <div class="filter">
          <ul id="filter">
              <?php if ( function_exists( 'get_option_tree') ) : if( get_option_tree( 'portfoliopdf_filter') ) : ?>
              
              <?php get_option_tree( 'portfoliopdf_filter', '', 'true' ); ?>
        ...
        <div class="portfoliowork">
          <?php 
		  $category = get_option_tree('portfoliopdf_categories');
		  $number = get_option_tree('portfoliopdf_show');
		  ?>
