...
<!-- #Page Back -->
    ...
    <div  class="grid_16 margin">
        ...
        <div class="bigtitle">
            <h1><?php if ( function_exists( 'get_option_tree') ) : if( get_option_tree( 'langsearchfor') ) : ?><?php get_option_tree( 'langsearchfor', '', 'true' ); ?>:<?php else : ?>Search Results for:<?php endif; endif; ?> <?php printf( __( '%s', '' ), '<span>' . get_search_query() . '</span>' ); ?> <?php if (have_posts()) : ?></h1>
            <h2><?php
    ...
    <div class="grid_16">
    	<div class="nofound">
        	<h1><?php if ( function_exists( 'get_option_tree') ) : if( get_option_tree( 'langsearchfound') ) : ?><?php get_option_tree( 'langsearchfound', '', 'true' ); ?><?php else : ?>Search Not Found :(<?php endif; endif; ?></h1>
        </div>
    </div>	
	<?php endif; ?> 
