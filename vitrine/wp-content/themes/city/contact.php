  ...
  <div class="grid_16 blog-list margin">
      ...
      <div class="bloglisting2">
          ...
          <ul id="1" class="listingblogul3">            
				...
				<?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'map', true) ) : ?>
                  <li>
                  <div class="overlay_fade">
                  <a class="iframe" href="<?php echo get_post_meta($post->ID, "map", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a>
                  <iframe width="900" height="460" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo get_post_meta($post->ID, "map", $single = true); ?>"></iframe>
                  </div>
                  </li>
                  <?php else : ?>
                  <li>
