<?php /** Template Name: Portfolio Iframe */ get_header(); ?>
...
<!-- #Page Back -->
    ...
    <div id="listportfolio" class="grid_16">
        ...
        <div class="filter">
          <ul id="filter">
              <?php if ( function_exists( 'get_option_tree') ) : if( get_option_tree( 'portfolioiframe_filter') ) : ?>
              
              <?php get_option_tree( 'portfolioiframe_filter', '', 'true' ); ?>
        ...
        <div class="portfoliowork">
          <?php 
		  $category = get_option_tree('portfolioiframe_categories');
		  $number = get_option_tree('portfolioiframe_show');
		  ?>
          ...
          <ul id="portfolio" class="portfolioul">
			  ...
			  <?php endif; endif; ?>
                ...
                <ul id="<?php the_ID(); ?>" class="listingblogul">            
                  ...
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_template_directory_uri(); ?>/image/post/no.jpg"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/image/post/no.jpg&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb2', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb2", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb3', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb3", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb4', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb4", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb5', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb5", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb6', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb6", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb7', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb7", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb8', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb8", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb9', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb9", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
                  
                  <?php if ( function_exists( 'get_post_meta') ) : if( get_post_meta($post->ID, 'thumb10', true) ) : ?>
                  <li class="<?php echo get_post_meta($post->ID, "filter", $single = true); ?>"><div class="overlay_fade"><a class="iframe" href="<?php echo get_post_meta($post->ID, "iframe", $single = true); ?>"><div class="overlay_zoom zoom_black"></div></a><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, "thumb10", $single = true); ?>&h=200&w=300" alt="" class="three-columb-img portfolioul-li-img" /></div></li>
                  <?php else : ?>
                  <?php endif; endif; ?>
